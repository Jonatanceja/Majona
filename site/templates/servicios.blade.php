...
<div class="flex content-center flex-wrap bg-local bg-cover h-screen" style="background-image: url('/images/servicios-portada.jpg'); border-left: 3rem solid white; border-right: 3rem solid white; border-bottom: 3rem solid white">
...
<div class="flex flex-wrap bg-gray-200 py-16 bg-fixed bg-cover" style="background-image: url('/images/servicio-bodega.jpg');">
